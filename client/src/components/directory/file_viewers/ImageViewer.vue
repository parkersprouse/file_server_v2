<template>
  <Dialog>
    ...
    <DialogContent class='image-file-dialog'>
...
.image-file-dialog {
  ...
  & .file-dialog--content {
    @apply flex flex-row flex-nowrap grow-0 shrink items-start justify-center
           max-w-full! max-h-full! h-full! overflow-y-auto;
