...
export const itemVariants = cva(
  '[a]:hover:bg-muted rounded-none border text-sm group/item flex w-full flex-wrap items-center transition-colors duration-100 outline-none [a]:transition-colors',
  {
    variants: {
      variant: {
